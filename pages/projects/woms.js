...
const projectData = {
    ...
    text: `The monolithic Workload Management System (WoMS) managed rogramming homework for many IDH courses since 2012. It required intensive maintenance, refactoring and enhancements to the functionality until it was discontinued. I was entrusted with these tasks as a student assistant. In order to improve the usability and user experience of the application in the long term, I conducted semi-structured interviews with different people involved and performed card sortings. For the enhancement of the functions I relied on user stories and personas, which were developed with a group of fellow students. 
        ...
        <Container>
            ...
            <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
                <div className="mb-8">
                    ...
                    <h1 className="font-bold text-3xl md:text-5xl tracking-tight mb-4 text-gray-800 dark:text-gray-200">
                        {projectData.title}
                    </h1>
                    <h2 className="mb-8 prose leading-6 text-gray-800 dark:text-gray-200">{projectData.tagline}</h2>
                    <Image
                ...
                <div className="mb-8">
                    {
                        projectData.time && (
                            <>
                                ...
                                <p className="mb-4 prose leading-6 text-gray-800 dark:text-gray-200 text-justify">{projectData.time}</p>
                            </>
                        )
                    }
                    {
                ...
                <div className="mb-8 prose text-justify leading-6 text-gray-800 dark:text-gray-200">
                    <p dangerouslySetInnerHTML={{ __html: projectData.text }} />
                </div>
